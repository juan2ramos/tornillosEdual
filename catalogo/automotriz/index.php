...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Tornillos edual Linea automotriz</title>
        <style type="text/css">
            <!--
    ...
    <body>
        <div id="outer_container">
            <div id="customScrollBox">
                <div class="container">
                    <div class="content">
                        <h1><span class="lightgrey">Catalogo 2012</span> <br /><span class="light"><span class="grey"><span class="s36">Linea automotriz</span></span></span></h1>
                        <p>En la l&iacute;nea comercial contamos con la m&aacute;s amplia Gama de Pernos para carro de todo el pa&iacute;s con la calidad que nos identifica, comprometidos con la responsabilidad que exige que un veh&iacute;culo sea ensamblado en el mercado</p>
                        <div id="toolbar"></div><div class="clear"></div>
                        <?php
                        for ($i = 0; $i < 91; $i++) {
                            ?>
                        <a href="imgs/LA<?php echo $i;?>.jpg" class="thumb_link"><span class="selected"></span><img src="imgs/LAT<?php echo $i;?>.jpg" title="Linea automotriz" alt="Linea automotriz" class="thumb" width="145" height="100"  /></a>
                            <?php
                        }
                        ?>
                        <p class="clear"></p>
        ...
        <div id="bg">
            <img src="imgs/LA0.jpg" title="Linea automotriz" id="bgimg" />
