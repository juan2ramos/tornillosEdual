...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Tornillos edual Otros productos</title>
        <style type="text/css">
            <!--
    ...
    <body>
        <div id="outer_container">
            <div id="customScrollBox">
                <div class="container">
                    <div class="content">
                        <h1><span class="lightgrey">Catalogo 2012</span> <br /><span class="light"><span class="grey"><span class="s36">Otros productos</span></span></span></h1>
                        <p>Fabricamos con caracter&iacute;sticas de dise&ntilde;o y construcci&oacute;n que les permiten una perfecta adaptaci&oacute;n a muy variadas condiciones y circunstancias de trabajo</p>
                        <div id="toolbar"></div><div class="clear"></div>
                        <?php
                        for ($i = 0; $i < 14; $i++) {
                            ?>
                        <a href="imgs/OP<?php echo $i;?>.jpg" class="thumb_link"><span class="selected"></span><img src="imgs/OPT<?php echo $i;?>.jpg" title="Otros productos" alt="Otros productos" class="thumb" width="145" height="100"  /></a>
                            <?php
                        }
                        ?>
                        <p class="clear"></p>
        ...
        <div id="bg">
            <img src="imgs/OP0.jpg" title="Otros productos" id="bgimg" />
